  ...
  return (
    <>
      <div className="w-full h-[65px] bg-white-light">
        <div className="flex xl:ml-[75px] lg:ml-[30px] md:ml-[20px]">
          <img
            src={logo}
            alt="logo"
            className="my-[27.5px]
           sm:w-[162.31px] sm:h-[30px]
           xs:w-[108px] xs:h-[25px]
           "
          ></img>
          <div
            ...
            <div className="flex">
              ...
              rounded-full border border-black-darkborder font-medium text-[15px]
               border-r-black-darkborder border-r-[7px] border-b-[5px] drop-shadow-2xl"
                  ...
                  <div className="xl:ml-[16px] lg:ml-[16px] md:ml-[5px] sm:ml-[1px] xs:ml-[5px] my-[6px]">
                    <button
              ...
              <div className="sm:ml-[15px] md:hidden">
                <button
                  onClick={toggleMenu}
