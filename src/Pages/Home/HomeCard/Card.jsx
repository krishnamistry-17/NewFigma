...
const Card = () => {
  return (
    <>
      <div className="bg-sky-bg w-full md:h-[756px] sm:h-[495px]">
        <div
          className="
        xl:mx-[75px] lg:mx-[60px] md:mx-[30px] sm:mx-[10px] xs:mx-[7px]
        xl:py-[128px] lg:py-[100px] md:py-[80px] sm:py-[50px] xs:py-[40px]
        ...
        >
          <div className="xl:w-[793.84px] xl:h-[500px]">
            ...
            md:text-[60px] sm:text-[32px] xs:text-[22px] text-black-heads md:max-w-[779px]"
            >
