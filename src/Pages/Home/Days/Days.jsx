...
const Days = () => {
  return (
    <>
      <div className="bg-green-lightbg w-full sm:h-[643.09px] xs:h-[517px] font-inter">
        <div className="xl:mx-[208px] lg:mx-[208px] md:mx-[150px] sm:mx-[30px] xs:mx-[20px]">
          ...
          <div className="h-[226.09px] sm:flex xl:mt-[110px]  ">
            ...
            <div className="xl:ml-[170px] lg:ml-[50px] md:ml-[40px] sm:ml-[30px] xs:ml-[4px] sm:mt-[0px] xs:mt-[-31px]">
              <img
                src={five}
                alt="fi"
                className="
              sm:w-[228px] sm:h-[201px]
              xs:w-[170px] xs:h-[119px]
              "
              />
            ...
            <div
              className="xl:ml-[170px] lg:ml-[15px] md:ml-[40px] sm:mt-[0px] xs:mt-[18px]
             sm:ml-[20px]  xs:ml-[10px] xl:my-[52.05px] xl:w-[228px] xl:h-[122px]"
            >
